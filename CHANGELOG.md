...
[Unreleased]: https://github.com/pluslatte/vrc-avatar-switcher/compare/v0.5.1

## [0.5.0] - 2026-06-13

### Changed

- アプリの起動後、認証確認の成功・失敗を待たずにアバター一覧へ進むように変更
- 認証情報の取り扱い変更により、再ログインが必要になります

[0.5.0]: https://github.com/pluslatte/vrc-avatar-switcher/compare/v0.5.0
...
[0.4.3]: https://github.com/pluslatte/vrc-avatar-switcher/releases/tag/v0.4.3
...
- VRChat API の仕様変更により、ユーザー情報の取得に失敗していたのを修正（
  vrchatapi-rust が修正されるまで、自分でパッチを当てたバージョンを使用。）
...
[0.4.0]: https://github.com/pluslatte/vrc-avatar-switcher/releases/tag/v0.4.0
...
- 使用中のアバター画像が完全に隠れないように変更 (thanks
  [Azukimochi](https://github.com/Azukimochi) !)
